...
public class BmiCalculator{
	public static void main(String[]args){
		...
		if(bmi<18.5){System.out.println("UNDERWEIGHT which is Corncerning: eat foods with alot of fats, proteins and get on the body Scale more often to track your body gain process");}
		else if(bmi>=18.5 && bmi <25){System.out.println("NORMAL WEIGHT  which is Good: Exercise 1-3 times a week  to maintain");}
		...
		else if(bmi>=30 && bmi <35){System.out.println("OBESE!! which is too Corncerning :Join Earobix classes and diet to healthy foods to lose weight");}
